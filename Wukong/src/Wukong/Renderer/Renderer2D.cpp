...
namespace Wukong
{
	...
	void Renderer2D::Init()
	{
		...
		//s_Data.WhiteTexture = Texture2D::Create("assets/textures/awesomeface.png");

		int32_t samplers[s_Data.MaxTextureSlots];
		for (uint32_t i = 0; i < s_Data.MaxTextureSlots; i++)
			samplers[i] = i;
		s_Data.TextureShader = Shader::Create("Texture","assets/shaders/Texture.vs", "assets/shaders/Texture.fs");
